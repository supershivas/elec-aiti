...
// commentés puis liaisons commentées, dans l'ordre du Store. Même liste
// consommée par ComponentsLayer et LinksLayer (pastilles affichées en
// direct sur le plan) et par io/exportPlan.js (liste "Notes" sous la
// légende), pour qu'un même élément commenté porte toujours le même numéro
// partout — un commentaire reste sinon un simple <title> au survol,
